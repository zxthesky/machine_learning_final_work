...
parser.add_argument('--setting_name', type=str, default='Crossformer_ETTh1_il96_ol96_sl6_win2_fa10_dm256_nh4_el3_itr0', help='name of the experiment')
...
parser.add_argument('--data_split', type=str, default='0.6,0.2,0.2', help='data split of train, vali, test')
...
parser.add_argument('--itr', type=int, default=5, help='iteration you need')
...
for i in range(args.itr):
    settingname = f'Crossformer_ETTh1_il96_ol96_sl6_win2_fa10_dm256_nh4_el3_itr{i}'
    mae, mse, rmse, mape, mspe = exp.eval(settingname, args.save_pred, args.inverse)
    maes.append(mae)
    mses.append(mse)
print('----------------------')
print(maes)
