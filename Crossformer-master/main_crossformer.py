...
parser.add_argument('--data_split', type=str, default='0.6,0.2,0.2',help='train/val/test split, can be ratio or number')
...
parser.add_argument('--out_len', type=int, default=336, help='output MTS length (\tau)')
...
parser.add_argument('--learning_rate', type=float, default=3e-5, help='optimizer initial learning rate')
